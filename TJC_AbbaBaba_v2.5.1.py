        ...
        for column in range(len(row)):
            ...
            if chrom!=chrom_change:
                ...
                if prev_pos < windowSize:
                    ...
                    line_toAppend = str(chrom_change)+"\t"+str(block_range)+"\t"+str(ABBA)+"\t"+str(BABA)+"QQQQQQQQQQQQQQQQQQ\n"

                else:

                    block_range = str(start_pos)+"-"+str(prev_pos)

                    line_toAppend = str(chrom_change)+"\t"+str(block_range)+"\t"+str(ABBA)+"\t"+str(BABA)+"YYYYYYYYYYYYYYYYYY\n"
            ...
            if pos/windowSize == blockNum:
                ...
                line_toAppend = str(chrom)+"\t"+str(block_range)+"\t"+str(ABBA)+"\t"+str(BABA)+"NNNNNNNNN\n"
