    ...
    for line in f:
        ...
        for column in range(len(row)):
            ...
            if chrom!=chrom_change:
                ...
                line_toAppend = str(chrom_change)+"\t"+str(block_range)+"\t"+str(AABA)+"\t"+ str(ABAA)+ "\t"+str(ABBA)+ "\t"+str(BAAA)+ "\t"+str(BABA)+ "\t"+str(BBAA)+"\t"+ str(BBBA)+"\t"+str(Other)+"\t"+str(val)+"\t" +str(pval)+"\n"
                #print line_toAppend
            ...
            if pos/500000 == blockNum:
                ...
                (val,pval)=chi2_test(ABBA,BABA)
                line_toAppend = str(chrom)+"\t"+str(block_range)+"\t"+str(AABA)+ "\t"+str(ABAA)+"\t"+ str(ABBA)+"\t"+ str(BAAA)+ "\t"+str(BABA)+"\t"+ str(BBAA)+"\t"+ str(BBBA)+"\t"+str(Other)+"\t"+str(val)+"\t" +str(pval)+"\n"
                #print line_toAppend
                #print row[0],"\t",pos,"\n"
