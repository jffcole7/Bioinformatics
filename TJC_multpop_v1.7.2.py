        ...
        for column in range(len(row)):
            ...
            #
                    ...
                    if pop2Members== pop2Tot-1:
                        ...
                        CombinedString=pop2string+pop1Alleles
                        #print CombinedString
                        #pop2string=""
                        #pop2Alleles=pop2string
                        #pop2string=""
                        if CandidatePos!=pos or unique_count(CombinedString)>2:
                            #CandidatePos=pos
                            #if unique_count(pop2string)==2:
                            #pop2freq=AlleleFreq(pop2string)
                            pop2string=""
                ...
                if column in pop3Inds:
                    ...
                    if pop3Members== pop3Tot-1:
                        ...
                        #pop3string=""
                        CombinedString=pop1Alleles+pop2Alleles+pop3string
                        #pop3Alleles=pop3string
                        #pop3string=""
                        if CandidatePos!=pos or unique_count(CombinedString)>2 :
                            #print pop3string
                        ...
                        pop3Alleles=pop3string
                        pop3string=""
                        print "pop3: "+ pop3Alleles+" position: "+ pos


                            #
                        # print "pop1: " +pop1Alleles +" position: " +CandidatePos
                        # print "pop2: "+pop2Alleles+" position: " +CandidatePos
                        # print "pop3: "+pop3Alleles+" position: " +pos
#
#
                ...
                if column in pop4Inds:
                    ...
                    if pop4Members== pop4Tot-1:
                        ...
                        print pop1Alleles+" "+pop2Alleles+" "+pop3Alleles+" "+pop4string+" "+pos+" "+CandidatePos
