...
with open(outName,'wb') as out:
        out.write("chrom\tblockRange\tAABA\tABAA\tABBA\tBAAA\tBABA\tBBAA\tBBBA\tOther\tNcount\n")
#
#
    ...
    for line in f:
        ...
        for column in range(len(row)):
            ...
            if chrom!=chrom_change:
                ...
                line_toAppend = str(chrom_change)+"\t"+str(block_range)+"\t"+str(AABA)+"\t"+ str(ABAA)+ "\t"+str(ABBA)+ "\t"+str(BAAA)+ "\t"+str(BABA)+ "\t"+str(BBAA)+"\t"+ str(BBBA)+"\t"+str(Other)+"\t"+str(Ncount)+"\t"+str(N1)+"\t"+str(N2)+"\t"+str(N3)+"\t"+str(N4)+"\n"
                #print line_toAppend
            ...
            if pos/500000 == blockNum:
                ...
                line_toAppend = str(chrom)+"\t"+str(block_range)+"\t"+str(AABA)+ "\t"+str(ABAA)+"\t"+ str(ABBA)+"\t"+ str(BAAA)+ "\t"+str(BABA)+"\t"+ str(BBAA)+"\t"+ str(BBBA)+"\t"+str(Other)+"\t"+str(Ncount)+"\t"+str(N1)+"\t"+str(N2)+"\t"+str(N3)+"\t"+str(N4)+"\n"
                #print line_toAppend
                #print row[0],"\t",pos,"\n"
