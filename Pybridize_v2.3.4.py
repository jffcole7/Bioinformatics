...
#####################################################################################
        if freq_bool:
            for i in range(len(pop1Array)):
                pop1pos = pop1Array[i]
                if row[pop1pos] not in AcceptedNucleotides:
                    break
                else:
            ...
            for i in range(len(pop2Array)):
                pop2pos = pop2Array[i]
                if row[pop2pos] not in AcceptedNucleotides:
                    break
                else:
            ...
            for i in range(len(pop3Array)):
                pop3pos = pop3Array[i]
                if row[pop3pos] not in AcceptedNucleotides:
                    break
                else:
                    pop3Alleles+= row[pop3pos]
            for i in range(len(pop4Array)):
                pop4pos = pop4Array[i]
                if row[pop4pos] not in AcceptedNucleotides:
                    break
                else:
