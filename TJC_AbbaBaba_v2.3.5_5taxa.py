...
with open(outName,'wb') as out:
    out.write("chrom\tblockRange\tAAAAA\tAAABA\tAABAA\tAABBA\tABAAA\tABABA\tABBAA\tABBBA\tBAAAA\tBAABA\tBABAA\tBABBA\tBBAAA\tBBABA\tBBBAA\tBBBBA\tNcount\n")
#
    ...
    for line in f:
        ...
        for column in range(len(row)):
            ...
            if chrom!=chrom_change:
                ...
                line_toAppend= str(chrom_change)+"\t" +str(block_range)+"\t"+str(AAAAA)+"\t"+ str(AAABA)+"\t"+ str(AABAA)+"\t"+ str(AABBA)+"\t"+ str(ABAAA)+"\t"+ str(ABABA)+"\t"+ str(ABBAA)+"\t"+ str(ABBBA)+"\t" + str(BAAAA) +"\t"+str(BAABA) +"\t"+ str(BABAA) +"\t"+str(BABBA) +"\t"+str(BBAAA) +"\t"+str(BBABA) +"\t"+str(BBBAA) +"\t"+str(BBBBA)+"\t"+str(Ncount)+"\n"
...
#
            ...
            if pos/500000 == blockNum:
                ...
                line_toAppend= str(chrom)+"\t" +str(block_range)+"\t"+str(AAAAA)+"\t"+ str(AAABA)+"\t"+ str(AABAA)+"\t"+ str(AABBA)+"\t"+ str(ABAAA)+"\t"+ str(ABABA)+"\t"+ str(ABBAA)+"\t"+ str(ABBBA)+"\t" + str(BAAAA) +"\t"+str(BAABA) +"\t"+ str(BABAA) +"\t"+str(BABBA) +"\t"+str(BBAAA) +"\t"+str(BBABA) +"\t"+str(BBBAA) +"\t"+str(BBBBA)+"\t"+str(Ncount)+"\n"
